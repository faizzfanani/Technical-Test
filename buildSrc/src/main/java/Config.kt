object Config {
    ...
    // namespace(s)
    const val applicationId = "id.faizzfanani.technical-test"
    const val baseNameSpace = "id.faizzfanani.technical-test"
    ...
    const val featureGithubNamespace = "${baseNameSpace}.feature_github"
